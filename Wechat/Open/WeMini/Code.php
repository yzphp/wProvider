...
class Code extends BasicWeChat
{
    ...
    public function getWxacode($path, $width = 430, $auto_color = false, $line_color = ["r" => "0", "g" => "0", "b" => "0"], $is_hyaline = false, $outType = null)
    {
    ...
    /**
     * 18、查询服务商的当月提审限额（quota）和加急次数
     * @return array
     * @throws \WeChat\Exceptions\InvalidResponseException
     * @throws \WeChat\Exceptions\LocalCacheException
     */
    public function getQueryQuota()
    {
