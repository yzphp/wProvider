...
class Account extends BasicWeChat
{
    ...
    public function modifyHeadImage($headImgMediaId, $x1 = 0, $y1 = 0, $x2 = 1, $y2 = 1)
    {
        ...
        $this->registerApi($url, __FUNCTION__, func_get_args());
        return $this->httpPostForJson($url, ['head_img_media_id' => $headImgMediaId,'x1'=>$x1, 'x2'=>$x2, 'y1'=>$x1, 'y2'=>$x2]);
    }
    ...
    public function modifyCategory($first, $second, $certicates)
    {
        ...
        $this->registerApi($url, __FUNCTION__, func_get_args());
        return $this->httpPostForJson($url, ['first' => $first, 'second' => $second, 'certicates' => $certicates]);
    }
